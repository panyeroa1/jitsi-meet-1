...
/**
 * Signals that the configuration (commonly known in Orbit Conference as config.js)
...
/**
 * Signals that a configuration (commonly known in Orbit Conference as config.js)
...
/**
 * Stores a specific Orbit Conference config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Orbit Conference config.js to store.
 * @returns {Function}
 */
