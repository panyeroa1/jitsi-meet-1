...
export default [
     ...
     * provided by, for example, Orbit Conference SDK for iOS.
     *
     * @type string
     */
    'callDisplayName',
     ...
     * override/overwrite provided by, for example, Orbit Conference SDK for iOS.
     *
     * @type string
     */
    'callHandle',
     ...
     * which Orbit Conference is to work with a CallKit call created outside of Jitsi
     * Meet and to be adopted by Orbit Conference such as, for example, an incoming
     * and/or outgoing CallKit call created by Orbit Conference SDK for iOS
     * clients/consumers prior to giving control to Orbit Conference. As the value is
     * associated with a conference/meeting, the value makes sense not as a
     * deployment-wide configuration, only as a runtime configuration
     * override/overwrite provided by, for example, Orbit Conference SDK for iOS.
     *
