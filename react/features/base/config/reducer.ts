 ...
 * JitsiMeetJS#init(). The app will download config.js from the Orbit Conference
 ...
 * The app will download config.js from the Orbit Conference deployment and take its
 ...
 * config.js from the Orbit Conference deployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig; }) {
    ...
    const newState = merge(
        ...
        // downloaded from the Orbit Conference deployment because the former contains
