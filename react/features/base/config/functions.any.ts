...
/**
 * Restores a Orbit Conference config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Orbit Conference config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Orbit Conference"
    // }
    // We want to have:
    // json = {
    //     config: {
