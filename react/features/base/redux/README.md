Orbit Conference - redux state persistence
====================================
Orbit Conference has a persistence layer that persists specific subtrees of the redux
...
When it's done, Orbit Conference will automatically persist these subtrees and
