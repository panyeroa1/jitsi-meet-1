...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Orbit Conference in it.
     *
    ...
    /**
     * Getter for the large video element in Orbit Conference.
     *
    ...
    /**
     * Getter for the prejoin video element in Orbit Conference.
     *
    ...
    /**
     * Getter for participant specific video element in Orbit Conference.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Orbit Conference
    ...
    /**
     * Removes the listeners and removes the Orbit Conference frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Orbit Conference.
     *
     ...
     * Only applies to certain Orbit Conference deploys.
