 ...
 * interface to access Orbit Conference features by external applications that embed
 * Orbit Conference.
 */
class API {
    _enabled;
     ...
     * information from external applications that embed Orbit Conference. It also
