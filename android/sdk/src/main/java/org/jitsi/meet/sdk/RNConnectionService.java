...
/**
 * The react-native side of Orbit Conference's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Orbit Conference to
     *        a conference call.
     * @param handle - a call handle which by default is Orbit Conference room's URL.
