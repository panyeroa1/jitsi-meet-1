...
var config = {
    ...
    // Moves all Orbit Conference 'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    */
     ...
     * which is retrieved internally by Orbit Conference) (e.g. https://meet.jit.si/someMeeting
